...
#include "gnc_msgs/msg/detail/trajectory_point__rosidl_typesupport_fastrtps_cpp.hpp"
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_gnc_msgs
cdr_serialize(
  const gnc_msgs::msg::TrajectoryPoint & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  gnc_msgs::msg::TrajectoryPoint & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = gnc_msgs::msg::TrajectoryPoint;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const gnc_msgs::msg::TrajectoryPoint *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<gnc_msgs::msg::TrajectoryPoint *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_gnc_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<gnc_msgs::msg::TrajectoryPoint>()
{
  return &gnc_msgs::msg::typesupport_fastrtps_cpp::_TrajectoryPoint__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, gnc_msgs, msg, TrajectoryPoint)() {
  return &gnc_msgs::msg::typesupport_fastrtps_cpp::_TrajectoryPoint__handle;
}
