...
#include "gnc_msgs/msg/detail/trajectory_point__rosidl_typesupport_fastrtps_c.h"
...
#include "gnc_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_gnc_msgs
...
using _TrajectoryPoint__ros_msg_type = gnc_msgs__msg__TrajectoryPoint;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gnc_msgs
size_t get_serialized_size_gnc_msgs__msg__TrajectoryPoint(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _TrajectoryPoint__ros_msg_type * ros_message = static_cast<const _TrajectoryPoint__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _TrajectoryPoint__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_gnc_msgs__msg__TrajectoryPoint(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_gnc_msgs
size_t max_serialized_size_gnc_msgs__msg__TrajectoryPoint(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = gnc_msgs__msg__TrajectoryPoint;
    is_plain =
      (
...
static size_t _TrajectoryPoint__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_gnc_msgs__msg__TrajectoryPoint(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, gnc_msgs, msg, TrajectoryPoint)() {
